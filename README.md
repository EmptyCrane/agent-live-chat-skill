...
Install the audited `v0.1.0-beta.11` release globally for Codex:
...
- The pinned installer targets the audited `v0.1.0-beta.11` prerelease. It retains the Beta 10 startup-ownership fixes and restores wheel and touch scrolling in the mobile participant sheet while keeping its header controls visible.
