...
Install the audited `v0.1.0-beta.10` release globally for Codex:
...
- The pinned installer targets the audited `v0.1.0-beta.10` prerelease. It retains the Beta 9 reliability fixes and additionally fails closed for live PID/health mismatches and cleans up child processes after startup timeouts.
